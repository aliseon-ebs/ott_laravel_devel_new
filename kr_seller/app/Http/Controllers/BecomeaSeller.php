...
class BecomeaController extends Controller
{
    /**
    ...
    public function become_a_seller_index(Request $request)
    {
        ...
        return view('pages.becomeaseller.index', ['data' => ['general_setting' => $general_setting,
    ...
    public function atrend_detail(Request $request, $atrend_id)
    {
        ...
        return view('pages.becomeaseller.detail', ['request' => $atrend_id]);
