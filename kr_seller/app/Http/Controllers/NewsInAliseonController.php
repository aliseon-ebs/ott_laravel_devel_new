...
class NewsInAliseonController extends Controller
{
    /**
    ...
    public function news_in_aliseon_index(Request $request)
    {
        ...
        return view('pages.newsinaliseon.index', ['data' => ['general_setting' => $general_setting,
    ...
    public function news_in_aliseon_detail(Request $request, $atrend_id)
    {

        return view('pages.newsinaliseon.news_in_aliseon_detail', ['request' => $atrend_id]);
