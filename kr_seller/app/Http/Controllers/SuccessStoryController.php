...
class SuccessStoryController extends Controller
{
    ...
    public function success_story_index(Request $request)
    {
        ...
        return view('pages.successstory.index', ['data' => ['general_setting' => $general_setting,
    ...
    public function success_story_detail(Request $request, $atrend_id)
    {

        

        return view('pages.successstory.success_story_detail', ['request' => $atrend_id]);
