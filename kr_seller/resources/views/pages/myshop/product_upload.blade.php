            ...
            <div class="card">
                <div class="card-body">  
                    ...
                    <div class="card-content">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-md-2 col-form-label" id ="seller" >카테고리</label>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card-content">
                        <div class="form-group row">
                            ...
                            <label for="example-text-input" class="col-md-2 col-form-label" >{{ $data['seq'] }}</label>
                        </div>
                    </div>
