    ...
    <div class="card-body">
        <div class="say_carousel_wr">
            ...
            <div class="say_carousel"> 
                ...
                <div id="reviewExampleControls2" class="carousel slide review-carousel" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div>
                                <p><img src="/images/common/meetup_logo.png"> {{ $review_con }}</p>
                    ...
                    <a class="carousel-control-prev" href="#reviewExampleControls2" role="button" data-slide="prev">
                        <i class="mdi mdi-chevron-left carousel-control-icon"></i>
                    </a>
                    <a class="carousel-control-next" href="#reviewExampleControls2" role="button" data-slide="next">
