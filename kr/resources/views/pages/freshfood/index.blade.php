...
<!-- page script -->
<script src="{{ URL::asset('/js/freshfood/freshfood.js')}}"></script>

<div id="fresh" class="sub">
  <div class="page_fresh_top_wr">
    <div class="sub_visual fresh_visual">
      <img src="http://kr.aliseon.com/images/freshfood/fresh_visual.png"class="atrend_rev_big_slide_img">
      <div class="wrapper">
  ...
  <div class="page_fresh_wr">    
    <div class="page_fresh">
      ...
      <div class="wrapper3">
        @include('layouts.freshfood.store_slider')
      </div>
    </div>
  </div>
  <!-- } page_fresh -->
  ...
  <div class="page_fresh_wr">
    <div class="wrapper">
      <div class="page_fresh card_5">
        ...
        @include('layouts.freshfood.fresh_list_slider') 
      </div>
    </div>
  </div>
  <!-- } O2O Product & Service  -->
  ...
  <div class="page_fresh_wr">
    <div class="wrapper">
      <div class="page_fresh">
        ...
        @include('layouts.freshfood.lifeon_slider')
      </div>
    </div>
  </div>
  <!-- } Life on O2O -->
