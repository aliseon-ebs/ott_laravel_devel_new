...
class ExhibitionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $general_setting['general_setting_exhibition_body'] = $general_setting_body;

        return view('pages.exhibition.index', ['data' => ['general_setting' => $general_setting,
    ...
    public function exhibition_detail(Request $request, $exhibition_id)
    {

        return view('pages.exhibition.detail', ['request' => $exhibition_id,]);
