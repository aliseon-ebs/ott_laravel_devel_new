...
<div id="event" class="sub">
  <div class="sub_visual event_visual"> 
    <img src="http://ko.aliseon.com/images/event/event_visual.jpg" class="atrend_rev_big_slide_img">  
    <div class="wrapper">      
          ...
          <div class="event_card2">
            <a href="" class="cf">
              ...
              <div class="event_card_img_wr">
                <img src="/images/event/event_img05.jpg" alt="">
              </div>
            </a>
          </div>
        </div>
        <div class="event_top_list">
          <div class="event_card2">
            <a href="" class="cf">
              ...
              <div class="event_card_img_wr">
                <img src="/images/event/event_img06.jpg" alt="">
              </div>
            </a>
          </div>
        </div>
  ...
  <div class="page_event_wr">
    <div class="wrapper">
      <div class="title_st04_box">
        ...
        <a href="http://ko.aliseon.com/event-coupon/lastevent/list/id" class="title_more_btn">Past Event<i class="arrow right"></i></a>
      </div>

      <div class="page_event card_4">
        @include('layouts.event_list_slider')
      </div>
    </div>
  </div>
  ...
  <div class="page_event_wr">
    <div class="wrapper">
      ...
      <div class="page_event card_4">
        @include('layouts.event_list_slider_down')
      </div>
    </div>
  </div>
</div>
