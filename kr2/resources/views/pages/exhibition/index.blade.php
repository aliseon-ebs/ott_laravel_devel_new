...
<!-- page script -->
<script src="{{ URL::asset('/js/exhibition.js')}}"></script>

<div id="exhibition" class="sub">
  <div class="sub_visual exhibition_visual">  
    <img src="http://ko.aliseon.com/images/exhibition/exhibition_visual.jpg" class="atrend_rev_big_slide_img">
    <div class="wrapper">      
  ...
  <div class="page_event_wr">
    ...
    <div class="wrapper2">
      <div class="page_event card_4">
        @include('layouts.exhibition_list_slider')
      </div>
    </div>
  </div>  
</div>
