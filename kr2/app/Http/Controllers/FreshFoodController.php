...
class FreshFoodController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $general_setting['general_setting_fresh_body'] = $general_setting_body;

        return view('pages.freshfood.index', ['data' => ['general_setting' => $general_setting,
