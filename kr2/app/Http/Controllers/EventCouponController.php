...
class EventcouponController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $general_setting['general_setting_event_body'] = $general_setting_body;

        return view('pages.event-coupon.index', ['data' => ['general_setting' => $general_setting,
    ...
    public function event_list(Request $request, $event_id)
    {

        return view('pages.event-coupon.lastevent_list', ['request' => $event_id]);

    }

    public function coupon_list(Request $request, $event_id)
    {

        return view('pages.event-coupon.lastcoupon_list', ['request' => $event_id]);

    }

    public function event_detail(Request $request, $event_id)
    {
    ...
    public function coupon_detail(Request $request, $event_id)
    {
