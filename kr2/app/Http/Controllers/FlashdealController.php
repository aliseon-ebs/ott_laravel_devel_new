...
class FlashdealController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       // body
        ...
        $general_setting['general_setting_flash_body'] = $general_setting_body;

        return view('pages.flashdeal.index', ['data' => ['general_setting' => $general_setting,
    ...
    public function flashdeal_product_detail(Request $request, $category_id)
    {

        return view('pages.flashdeal.flashdeal_list', ['request' => $category_id]);
